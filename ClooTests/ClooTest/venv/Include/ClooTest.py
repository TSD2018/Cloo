...
def Test2(driver,writer):
    ...
    #Add some comments
    ObjColl.AddTextById(driver,'com.example.cloo2019:id/editText_LooRatingComments','Add comments to this rating.')

    #Save the updates
    #ObjColl.ClickSubmitIdButton(driver)
    ObjColl.ClickButton(driver,'com.example.cloo2019:id/button_Submit')
